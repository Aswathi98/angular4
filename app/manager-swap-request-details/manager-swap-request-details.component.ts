...
@Component({
  selector: 'app-manager-swap-request-details',
  templateUrl: './manager-swap-request-details.component.html',
  styleUrls: ['./manager-swap-request-details.component.css']
})
export class ManagerSwapRequestDetailsComponent implements OnInit {
  val: string;
  users: Request1[];
